					  ...
					  <table class="table">
							<thead>
								<tr>
									...
									<th class="product-stock-stauts"><span class="nobr"> shipment Detials </span></th>
							...
							<tbody>
								...
								<tr>
									...
									<td class="product-name">
										<?php	if($row['ship_shipment_id']!=0){ echo "Shipment id:-". $row['ship_shipment_id']."<br>";
									 echo "Order id:-". $row['ship_order_id'];}
									 else
									 {
										echo "Your order is confirmed .<br> but not yet shipped.<br> Stay tuned for updates!";
									 }
									 ?>
									 </td>
